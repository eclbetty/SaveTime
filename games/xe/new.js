...
let upperReferenceNode = document.querySelector(
  "#playform > div.box-body > div:nth-child(1)"
);
let bottomReferenceNode = document.querySelector(
  "#playform > div.box-body > div:nth-child(12)"
);
let id = document.querySelector("#s_playerID").innerHTML;
...
let uselessNameInput = document.querySelector(
  "#playform > div.box-body > div:nth-child(7)"
);
let uselessTelInput = document.querySelector(
  "#playform > div.box-body > div:nth-child(8)"
);
let uselessDesc = document.querySelector(
  "#playform > div.box-body > div:nth-child(9)"
);

document.querySelector("#password").value = "Qwer123";
...
insertAfter(
  document.querySelector("#playform > div.box-body > div:nth-child(12)"),
  bonusRow
);
...
document.querySelector("#setscore").addEventListener("keyup", function () {
  amount = document.querySelector("#setscore").value;
});
